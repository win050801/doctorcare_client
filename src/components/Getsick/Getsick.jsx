            ...
            <div className="containergetsick">
                <div className="info">
                    ...
                    <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: 20 }}>
                        <div><span>Họ tên : </span> <input type="text" className="inputinfo"></input></div>
                        <div><span>Năm sinh : </span> <input className="inputinfo"></input></div>
                        <div><span>Tuổi : </span> <input className="inputinfo"></input></div>
                        <div><input type="checkbox"></input><span>Bệnh nhân cũ</span></div>
                    </div>
                    <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: 20 }}>
                        <div><span>Giới tính : </span> <select className="inputinfo" id="cars">
                            <option value="volvo">Nam</option>
                            <option value="saab">Nữ</option>
                            
                        </select></div>
                        <div><span>Địa chỉ : </span> <input className="inputinfo"></input></div>
                        <div><span>Điện thoại : </span> <input className="inputinfo"></input></div>
                        <div>
                            <span for="cars">Khoa chỉ định : </span>
                            <select className="inputinfo" id="cars">
